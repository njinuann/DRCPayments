 ...
 *         &lt;element name="rechargeCardPin" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "payByRechargeCard")
public class PayByRechargeCard {

    @XmlElement(required = true, nillable = true)
    protected String smartCardNum;
    @XmlElement(required = true, nillable = true)
    protected String rechargeCardPin;
    @XmlElement(required = true, nillable = true)
    ...
    /**
     * Gets the value of the rechargeCardPin property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getRechargeCardPin() {
        return rechargeCardPin;
    }

    /**
     * Sets the value of the rechargeCardPin property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setRechargeCardPin(String value) {
        this.rechargeCardPin = value;
    }
